  ...
  return (
    <div className="my-3">
      <div className="flex flex-row text-xl">
        ...
        <span className="text-accent-color dark:text-accent-color-dark">
      ...
      <div>
        <div className="p-1 font-mono text-sm text-gray-500 dark:text-gray-500">{location}</div>
        <div className="p-1 font-mono text-sm text-gray-400 dark:text-gray-600">{range}</div>
        <div className="p-2">
          <div className="flex flex-row ">
            <div className="mr-2 text-lg text-accent-color dark:text-accent-color-dark">
              {' '}
              &#8227;
            </div>
